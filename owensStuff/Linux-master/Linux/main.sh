#!/bin/bash
#MIT Licence 
#Copyright Aidan Underwood Team 13-1981, NEISD STEM LEE
echo Made by Aidan Underwood
echo Be sure to run this file as Root and make sure you CD into the directory.
...
zeroUidFun(){
	...
	if [ -s /zerouidusers ]
	then
		echo "There are Zero UID Users. Fixing..."
...
aptInstFun(){
	...
	#This will download lynis 3.0.1, which may be out of date as of 10/15/2020
	wget https://cisofy.com/files/lynis-3.0.1.tar.gz -O /lynis.tar.gz
